        ...
        <nav className="fixed top-0 left-0 w-full z-50 border-b border-white/5 bg-background-dark/80 backdrop-blur-md">
          <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <button onClick={onStartJourney} className="bg-primary/10 hover:bg-primary/20 text-primary border border-primary/50 hover:border-primary hover:shadow-[0_0_15px_rgba(0,240,255,0.4)] px-6 py-2 rounded-full text-sm font-bold transition-all duration-300">
                Get Access
              </button>
            </div>
          </div>
